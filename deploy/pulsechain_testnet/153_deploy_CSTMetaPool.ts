...
// Deployment names
const META_POOL_NAME = "PascalCSTMetaPool"
const META_POOL_LP_TOKEN_NAME = `${META_POOL_NAME}LPToken`
const BASE_POOL_NAME = "PascalUSDPool"
// Constructor arguments
const TOKEN_NAMES = ["CST", `${BASE_POOL_NAME}LPToken`]
const TOKEN_DECIMALS = [18, 18]
const LP_TOKEN_NAME = "Pascal CST/USD"
const LP_TOKEN_SYMBOL = "pascalCST-USD"
const INITIAL_A = 100
