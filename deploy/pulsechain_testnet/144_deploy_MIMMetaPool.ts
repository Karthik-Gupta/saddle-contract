...
// Deployment names
const META_POOL_NAME = "TuringMIMMetaPool"
const META_POOL_LP_TOKEN_NAME = `${META_POOL_NAME}LPToken`
const BASE_POOL_NAME = "TuringUSDPool"
// Constructor arguments
const TOKEN_NAMES = ["MIM", `${BASE_POOL_NAME}LPToken`]
const TOKEN_DECIMALS = [18, 18]
const LP_TOKEN_NAME = "Turing MIM/turingUSD"
const LP_TOKEN_SYMBOL = "turingMIM-USD"
const INITIAL_A = 100
