...
// Deployment names
const META_POOL_NAME = "PascalPWCMetaPool"
const META_POOL_LP_TOKEN_NAME = `${META_POOL_NAME}LPToken`
const BASE_POOL_NAME = "PascalUSDPool"
// Constructor arguments
const TOKEN_NAMES = ["PWC", `${BASE_POOL_NAME}LPToken`]
const TOKEN_DECIMALS = [8, 18]
const LP_TOKEN_NAME = "Pascal PWC/USD"
const LP_TOKEN_SYMBOL = "pascalPWC-USD"
const INITIAL_A = 100
