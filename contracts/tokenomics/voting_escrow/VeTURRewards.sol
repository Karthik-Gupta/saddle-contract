...
/** @title VeTURRewards
    @notice Gauge like contract that simulates veTUR stake.
 */

contract VeTURRewards {
    ...
    // whitelisted addresses have right to claim and lock into veTUR on anothers behalf
    ...
    /** @notice use to update rewards on veTUR balance changes.
        @dev called by veTUR
     *  @return true
     */
     ...
     * @param _lock should it lock rewards into veTUR
     * @return true
     */
